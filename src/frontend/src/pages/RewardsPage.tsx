  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-2xl">
      ...
      <div className="text-center mb-10">
        ...
        <p className="font-pixel text-xs text-accent mb-3 neon-text-green">— XP TRACKER —</p>
        <h1 className="font-display text-4xl font-bold text-foreground mb-3 tracking-wide">Rewards & Loot</h1>
        <p className="font-body text-muted-foreground font-medium">
          Earn XP with every purchase. Collect 5 items to unlock a free treat — your loyalty is legendary!
        </p>
      </div>
      ...
      {!isAuthenticated && (
        <div className="bg-card rounded-lg p-8 shadow-panel border neon-border-blue text-center">
          ...
          <h2 className="font-display text-2xl font-bold mb-2 tracking-wide">Log In to Track XP</h2>
          <p className="font-body text-muted-foreground mb-6 max-w-sm mx-auto font-medium">
            Sign in to view your XP balance, track your progress, and claim your free loot.
          </p>
          <Button
            onClick={login}
          ...
          <div className="mt-8 bg-secondary/50 rounded-lg p-4 border border-border">
            <h3 className="font-display text-base font-bold mb-2 tracking-wide">How It Works</h3>
        ...
        <>
          {(rewardsLoading || configLoading) ? (
            ...
            <div className="text-center py-12 text-muted-foreground font-body">
              <p className="font-semibold">⚠ Unable to load your XP. Please try again.</p>
            </div>
          ) : rewards && config ? (
            <RewardsStatus
              rewards={rewards}
