...
import { ChevronRight, Zap, Trophy, Gamepad2 } from 'lucide-react';
    ...
    <div>
        ...
        <div className="relative container mx-auto px-4 py-24 md:py-36">
          <div className="max-w-xl">
            ...
            <p className="font-body text-lg text-foreground/85 mb-8 leading-relaxed font-medium">
              Level up your snack game with epic baked goods, power-up pastries, and legendary treats. Every bite is a new high score.
            </p>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <p className="font-pixel text-xs text-accent mb-3 neon-text-green">— SELECT YOUR POWER-UP —</p>
      ...
      <section className="bg-secondary/30 border-y border-border py-14">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            <p className="font-pixel text-xs text-primary mb-3 neon-text-blue">— LOADING LEVEL —</p>
            ...
            <p className="font-body text-muted-foreground mt-2 max-w-lg mx-auto">
              From the neon-drenched depths of Rapture to the pixelated plains of the Mushroom Kingdom — our flavors are as legendary as the games that inspire them.
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { label: 'BioShock Special', desc: 'Would you kindly try our Big Daddy Brownie?', color: 'border-primary/40' },
              { label: 'Zelda Loaf', desc: 'It\'s dangerous to go alone. Take this bread.', color: 'border-accent/40' },
              { label: 'Mario Mushroom', desc: 'Super-sized muffins that make you grow.', color: 'border-gaming-purple/40' },
              { label: 'Halo Ring Cake', desc: 'Finish the fight — and the whole cake.', color: 'border-primary/40' },
            ].map((item, i) => (
              <div
                key={i}
              ...
              >
                ...
                <h4 className="font-display text-sm font-bold text-foreground mb-1 tracking-wide">{item.label}</h4>
      ...
      <section className="bg-primary/10 border-y border-primary/20">
        <div className="container mx-auto px-4 py-14 text-center">
          ...
          <p className="font-body text-lg text-muted-foreground mb-8 max-w-xl mx-auto">
            Browse our legendary menu and discover your new favorite power-up. Every bite tells an epic story.
          </p>
          <Button
            asChild
            size="lg"
