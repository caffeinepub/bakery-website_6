  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="space-y-1.5">
        <Label htmlFor="purchase-principal" className="font-body font-semibold tracking-wide">Player Principal ID *</Label>
        <Input
      ...
      <div className="space-y-1.5">
        <Label htmlFor="purchase-count" className="font-body font-semibold tracking-wide">Number of Items *</Label>
        <Input
          id="purchase-count"
          type="number"
          min="1"
      ...
      <Button type="submit" disabled={recordPurchase.isPending} className="w-full font-body font-bold gap-2 neon-glow-blue tracking-wide">
